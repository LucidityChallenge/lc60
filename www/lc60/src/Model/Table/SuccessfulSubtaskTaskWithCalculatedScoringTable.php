...
/**
 * SuccessfulSubtaskTaskWithCalculatedScoring Model
 *
 ...
 *
 * @method \App\Model\Entity\SuccessfulSubtaskTaskWithCalculatedScoring get($primaryKey, $options = [])
 * @method \App\Model\Entity\SuccessfulSubtaskTaskWithCalculatedScoring newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\SuccessfulSubtaskTaskWithCalculatedScoring[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\SuccessfulSubtaskTaskWithCalculatedScoring|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\SuccessfulSubtaskTaskWithCalculatedScoring patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\SuccessfulSubtaskTaskWithCalculatedScoring[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\SuccessfulSubtaskTaskWithCalculatedScoring findOrCreate($search, callable $callback = null, $options = [])
 */
class SuccessfulSubtaskTaskWithCalculatedScoringTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('lc60_successful_subtask_task_with_calculated_scoring');
