 ...
 * @property \App\Model\Table\TasksTable|\Cake\ORM\Association\BelongsTo $ContemporaryTasks
 * @property \App\Model\Table\SubtasksTable|\Cake\ORM\Association\BelongsTo $Subtasks
 * @property \App\Model\Table\TasksTable|\Cake\ORM\Association\BelongsTo $SubtaskTasks
 * @property \App\Model\Table\SubtasksTable|\Cake\ORM\Association\BelongsTo $SubtaskSupers
 * @property \App\Model\Table\SubtaskCategoriesTable|\Cake\ORM\Association\BelongsTo $SubtaskCategories
 * @property \App\Model\Table\ParticipantsTable|\Cake\ORM\Association\BelongsTo $SubtaskOwnerParticipants
 *
 * @method \App\Model\Entity\RecentSuccess get($primaryKey, $options = [])
 * @method \App\Model\Entity\RecentSuccess newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\RecentSuccess[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\RecentSuccess|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\RecentSuccess patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\RecentSuccess[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\RecentSuccess findOrCreate($search, callable $callback = null, $options = [])
 */
class RecentSuccessesTable extends Table
{
