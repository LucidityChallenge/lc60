...
/**
 * SuccessfulSubtaskTaskWithCalculatedScoringOwner Model
 *
 ...
 */
class SuccessfulSubtaskTaskWithCalculatedScoringOwnerTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('lc60_successful_subtask_task_with_calculated_scoring_owner');
/*
        ...
        $this->belongsTo('Participants', [
            'foreignKey' => 'id',
            'bindingKey' => 'participant_holder_id',
            'joinType' => 'INNER'
        ]);  
    }
