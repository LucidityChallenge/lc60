...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Subtask Share'), ['action' => 'edit', $subtaskShare->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Subtask Share'), ['action' => 'delete', $subtaskShare->id], ['confirm' => __('Are you sure you want to delete # {0}?', $subtaskShare->id)]) ?> </li>
